...
pub(crate) use bridge::{
    ...
    map_has_entry_address, map_len_entry_address, restore_exit_state_entry_address,
...
pub(crate) use codegen::{
    ...
    drop_shared_signature, entry_signature, free_buffer_signature, heap_len_signature,
    helper_signature, jump_with_status, pack_shared_signature, restore_exit_signature,
};
