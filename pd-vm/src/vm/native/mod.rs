...
pub(crate) use bridge::{
    ...
    OP_CGT, OP_CLT, OP_DIV, OP_DUP, OP_LDC, OP_LDLOC, OP_LSHR, OP_MOD, OP_MUL, OP_NEG, OP_NOT,
    OP_OR, OP_POP, OP_SHL, OP_SHR, OP_STLOC, OP_SUB, STATUS_CONTINUE,
    ...
    store_bridge_error, take_bridge_error, value_eq_entry_address, write_heap_value_to_slot_entry_address,
...
pub(crate) use inline::{
    HeapIntrinsicAddrs, HeapIntrinsicRefs, ResolvedOffsets, resolve_offsets,
};
